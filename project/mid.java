                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (s1.isEmpty() || hh.isEmpty() || rr.isEmpty()){
                        ...
                        JOptionPane.showMessageDialog(mid.this, "Account Name: " + name + "\n" + "Account Number: " + num + "\n" +
                              "Payment Method: " + box + "\n" + total.getText());
                        new last(name, num, box,
                                stf1.getText(), hrstf1.getText(), Rphtf1.getText(),
                                stf2.getText(), hrstf2.getText(), Rphtf2.getText(),
                                stf3.getText(), hrstf3.getText(), Rphtf3.getText(),
                                total.getText()).setVisible(true);
                        dispose();
                    }
